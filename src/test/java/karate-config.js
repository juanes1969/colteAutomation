function fn() {
    ...
    var config = {
        ...
        urlDecrypt: "https://appqadocker.coltefinanciera.com.co:7000/encryption-api/v0/",
        urlCreteClientsRemesas: "https://appqadocker.coltefinanciera.com.co:7000/remesas/api/transaccion/",
        xApiKeyRemesas: "18031e4e-bcca-4628-8f0b-92b9fc177c33",
        contentTypeRemesas: "text/plain",
        ssl: { trustAll: true }
    };
